            ...
            <div class="card">
                <div class="card-header">
                    <div class="section-header-button">
                        <a href="<?= base_url('fatin/add') ?>" class="main-btn primary-btn btn-hover btn-sm">
                            <i class="lni lni-plus"></i> Aumenta Fatin
                        </a>
                    </div>
                </div>
                <!-- BODY -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action d-flex gap-2 justify-content-center">
                                                    ...
                                                    <!-- Edit -->
                                                    <a href="<?= base_url('fatin/edit/' . $row['id_fatin']) ?>"
                                                        class="text-success" title="Hadia">
                                                        <i class="lni lni-pencil"></i>
                                                    </a>

                                                    <!-- Delete -->
                                                    <a href="<?= base_url('fatin/delete/' . $row['id_fatin']) ?>"
                                                        class="text-danger" id="btn-hamos" title="Apaga">
                                                        <i class="lni lni-trash-can"></i>
                                                    </a>

                                                    <!-- View -->
                                                    <a href="<?= base_url('fatin/note/' . $row['id_fatin']) ?>"
